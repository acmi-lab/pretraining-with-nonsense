...
class TextGenWordpiece(TextGen):
    ...
    def _join_tokens(self, token_list):
        ...
        if START_SYMBOL in token_list or \
             END_SYMBOL  in token_list or \
               "@@PADDING@@" in token_list or \
                 "@@padding@@" in token_list:
            print("Warning: found start/end/pad token in: ", token_list)
